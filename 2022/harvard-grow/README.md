...
https://twitter.com/SanchoPanzy/status/1586843744220889088
...
But Harvard is in Cambridge with plenty of infrastructure and [a massive endowment](https://en.wikipedia.org/wiki/Harvard_University_endowment).
...
https://twitter.com/wwwojtekk/status/1587502367653732354
...
But we also need to define a broad view of success. Diversity is good for everyone. ["Study after study confirms that diversity in the workforce contributes to the bottom line."](https://www.scotusblog.com/2022/10/a-business-perspective-diversity-in-university-admissions-is-a-compelling-interest/). It's also important to ensure [we can trust one another](  https://www.scotusblog.com/2022/10/affirmative-action-appears-in-jeopardy-after-marathon-arguments/):
...
https://twitter.com/ZaidJilani/status/1587980519547064320
...
All the same, universities like my alma mater have managed to [grow their educational achievement while keeping tuition stable](https://fleker.medium.com/reducing-college-costs-with-yimbyism-96fc9eceb47d). Looking at [race demographics](https://www.collegefactual.com/colleges/rowan-university/student-life/diversity/), it is not too far away from [New Jersey as a whole](https://www.census.gov/quickfacts/NJ). More can and should be done there.

But diversity and inclusion needs to factor in the inclusion part. Creating a tiny elite community behind a gate is undoubtedly going to make people angry. Harvard has gained a reputation as being an excellent school and telling students they can't attend is undoubtedly going to affect a lot of deserving students.

## Post-Affirmative Action world

Noah Smith [speculates the state of college admissions](https://noahpinion.substack.com/p/why-affirmative-action-had-to-go) in future decades. While affirmative action makes a lot of sense in helping Black students, it hasn't made sense when applied more broadly. In the current court case, it appears to have served as a liability. Asian students are not a monolith, and the plantiffs do have standing regardless of the views of a larger Asian community.

Affirmative action, and similar racial preferences, have been banned in some states for years. It [hasn't necessarily led to drops in diverse communities](https://www.scotusblog.com/2022/10/the-court-should-relegate-racial-discrimination-in-higher-education-to-the-dustbin-of-history/). It's not a guarantee that the percentage of Black students at Harvard will drop to 4%. In addition, as observed [during the case](https://www.scotusblog.com/2022/10/affirmative-action-appears-in-jeopardy-after-marathon-arguments/):
...
Student growth 3.5x to reach same number
Harvard endowment
